...
高可用的k8s的所有节点需要对外暴露80,443(ingress bare 部署需要)，这些node需要一个lb，然后将域名解析到这个lb上保证高可用。

haproxy 很好的提供了四层七层代理服务。
...
> [网上找的一份比较全的配置](http://www.manongjc.com/detail/23-usbrvnnuobpgdpn.html)
